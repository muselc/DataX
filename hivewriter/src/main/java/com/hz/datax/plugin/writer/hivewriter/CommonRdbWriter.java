...
//                connection.setAutoCommit(false);
        ...
        protected PreparedStatement fillPreparedStatement(PreparedStatement preparedStatement, Record record)
                throws SQLException {
            for (int i = 0; i < this.columnNumber && record.getColumn(i) != null; i++) {
            ...
            switch (columnSqltype) {
                ...
                case Types.LONGNVARCHAR:
                    preparedStatement.setString(columnIndex + 1,
                            column.asString() == null ? "NULL" : column.asString());
                    break;
                ...
                case Types.DOUBLE:
                    ...
                    if (emptyAsNull && "".equals(strValue)) {
                        ...
                        preparedStatement.setString(columnIndex + 1, strValue == null ? "NULL" : strValue);
                    }
                    break;
                ...
                case Types.TINYINT:
                    ...
                    preparedStatement.setString(columnIndex + 1, longValue == null ? "NULL" : longValue.toString());
                ...
                case Types.DATE:
                    ...
                    if (typeName.equalsIgnoreCase("year")) {
                         BigInteger bigInteger = column.asBigInteger();
                         if (bigInteger == null) {
                             preparedStatement.setNull(columnIndex + 1, Types.BIGINT);
                         }else {
                             preparedStatement.setInt(columnIndex + 1, bigInteger.intValue());
                         }
                    } else {
