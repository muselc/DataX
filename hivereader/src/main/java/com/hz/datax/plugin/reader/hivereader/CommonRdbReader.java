 ...
 *
 * @Author liansongye
 * @create 2021/8/17 11:26 上午
 */
public class CommonRdbReader {
    public static class Job {
        ...
        public void preCheck(Configuration originalConfig,DataBaseType dataBaseType) {
            ...
            String splitPK = queryConf.getString(com.alibaba.datax.plugin.rdbms.reader.Key.SPLIT_PK);
            List<Object> connList = queryConf.getList(Constant.CONN_MARK, Object.class);
            String username = queryConf.getString(com.alibaba.datax.plugin.rdbms.reader.Key.USERNAME);
            String password = queryConf.getString(com.alibaba.datax.plugin.rdbms.reader.Key.PASSWORD);
    ...
    public static class Task {
        ...
        public void init(Configuration readerSliceConfig) {
            ...
            this.username = readerSliceConfig.getString(com.alibaba.datax.plugin.rdbms.reader.Key.USERNAME);
            this.password = readerSliceConfig.getString(com.alibaba.datax.plugin.rdbms.reader.Key.PASSWORD);
            this.jdbcUrl = readerSliceConfig.getString(com.alibaba.datax.plugin.rdbms.reader.Key.JDBC_URL);
            ...
            this.mandatoryEncoding = readerSliceConfig.getString(com.alibaba.datax.plugin.rdbms.reader.Key.MANDATORY_ENCODING, "");
        ...
        public void startRead(Configuration readerSliceConfig,
            ...
            String querySql = readerSliceConfig.getString(com.alibaba.datax.plugin.rdbms.reader.Key.QUERY_SQL);
